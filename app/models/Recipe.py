class Recipe:
	def __init__(self, label, image, url, dietLabels, portions, healthLabels, cautions, ingredientLines, calories, totalTime, cuisineType, totalNutrients):
		...
		self.portions = portions # number of portions
